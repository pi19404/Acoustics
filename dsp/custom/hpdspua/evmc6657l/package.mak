...
override PKGDIR = custom/hpdspua/evmc6657l
...
package/%.xdc.inc package/%_custom.hpdspua.evmc6657l.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package custom.hpdspua.evmc6657l" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js custom.hpdspua.evmc6657l $@
...
.PHONY: release,custom_hpdspua_evmc6657l
custom_hpdspua_evmc6657l.zip: package/package.bld.xml
custom_hpdspua_evmc6657l.zip: package/package.ext.xml
custom_hpdspua_evmc6657l.zip: package/package.rel.dot
custom_hpdspua_evmc6657l.zip: package/build.cfg
custom_hpdspua_evmc6657l.zip: package/package.xdc.inc
custom_hpdspua_evmc6657l.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/custom_hpdspua_evmc6657l.zip.dep
endif
package/rel/custom_hpdspua_evmc6657l/custom/hpdspua/evmc6657l/package/package.rel.xml:

custom_hpdspua_evmc6657l.zip: package/rel/custom_hpdspua_evmc6657l.xdc.inc package/rel/custom_hpdspua_evmc6657l/custom/hpdspua/evmc6657l/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/custom_hpdspua_evmc6657l.xdc.inc,package/rel/custom_hpdspua_evmc6657l.zip.dep)


release release,custom_hpdspua_evmc6657l: all custom_hpdspua_evmc6657l.zip
clean:: .clean
	-$(RM) custom_hpdspua_evmc6657l.zip
	-$(RM) package/rel/custom_hpdspua_evmc6657l.xdc.inc
	-$(RM) package/rel/custom_hpdspua_evmc6657l.zip.dep
